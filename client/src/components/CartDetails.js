...
const CartDetails = () => {
    ...
    //// payment integration process is///
    const makePayment = async()=>{
        const stripe = await loadStripe("pk_test_51NjHgCSFzq7ZkV5cN3c4CLYfkRtAp5Bi8Wo7JoqRzCdbPc7ZPOSjd6O2TFlAYLxLxHHMsOdvLE0i8CezIdTG1TSX0052wMM6OD");
                                    ...
                                    <table className='table cart-table mb-0 table-responsive-sm'>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <th>&nbsp;</th>
                                                <th colSpan={2}>&nbsp;</th>
                                                <th>Items In Cart <span className='ml-1 mr-1'>:</span><span className='text-danger'>{totalquantity}</span></th>
                                                <th className='text-right'>Total Price<span className='ml-3 mr-1'>:</span><span className='text-danger'>₹ {totalprice}</span></th>
